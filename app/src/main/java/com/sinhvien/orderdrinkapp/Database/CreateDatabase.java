...
//Lớp CreateDatabase này là một lớp kế thừa từ SQLiteOpenHelper
// có vai trò tạo và quản lý cơ sở dữ liệu SQLite trong ứng dụng Android.
public class CreateDatabase extends SQLiteOpenHelper {

    //thiết lập tên của các bảng
    ...
    //Bảng nhân viên
    //thiết lập tên của các cột/trường trong bảng
    ...
    //khởi tạo nhận tham số context của ứng dụng
    //gọi đến hàm khởi tạo của lớp Cha SQLiteOpenHelper để thiết lập cơ sở dữ liệu
    ...
    //thực hiện tạo bảng
    @Override
    public void onCreate(SQLiteDatabase db) //Phương thức này được gọi tự động khi cơ sở dữ liệu được tạo lần đầu tiên.
    {
    ...
    //Phương thức này được gọi tự động khi phiên bản của cơ sở dữ liệu được tăng lên.
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {

    }

    //mở kết nối csdl
    //Phương thức này mở kết nối tới cơ sở dữ liệu và trả về đối tượng SQLiteDatabase
    // cho phép thực hiện các truy vấn và thao tác với dữ liệu.
