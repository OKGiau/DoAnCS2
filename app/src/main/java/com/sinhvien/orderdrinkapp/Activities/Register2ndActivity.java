...
public class Register2ndActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //nếu thông tin bên màn hình đăng ký không trống
        if(bundle != null) {
        ...
        //khởi tạo kết nối csdl, truy cập bảng
        nhanVienDAO = new NhanVienDAO(this);
        quyenDAO = new QuyenDAO(this);

//thiết lập trình xử lý lượt nhấp cho nút có tên BTN_signup_next
        BTN_signup_next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

//thực hiện kiểm tra xác thực độ tuổi và giới tính
...
//Xây dựng một chuỗi biểu thị ngày sinh được người dùng chọn từ thành phần DatePicker có tên DT_signup_NgaySinh
//.getMonth() + 1: do getMonth()trả về chỉ số tháng (dựa trên 0), trong khi chúng tôi thường muốn các tháng được biểu thị bằng 1-12.
    ...
    public void finish() {
        super.finish();
        overridePendingTransition(R.anim.slide_in_left,R.anim.slide_out_right);//hiệu ứng hoạt ảnh
    }
    ...
    public void callLoginFromRegister(){
        ...
        startActivity(intent);
        overridePendingTransition(R.anim.fade_in, R.anim.fade_out);//hiệu ứng hoạt ảnh
    }
